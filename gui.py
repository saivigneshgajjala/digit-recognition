...
txt=tk.Text(root,bd=3,exportselection=0,bg='WHITE',font='Magneto',
...
btnModel=Button(text="Display result",command=model)
btnClear=Button(text="Erase",command=clear)
##pack the buttons
btnModel.pack()
btnClear.pack()
txt.pack()
root.title('DIGIT RECOGNITION VNR VJIET')
root.mainloop()
